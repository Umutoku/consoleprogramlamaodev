...
namespace Hazir_metotlar_Datetime
{
    class Result
    {
        static void Main(string[] args){
            Console.WriteLine(DateTime.Now.Date); //Günün tarihini seçiniz
            ...
            //Math Kütüphanesi
             ...
             Console.WriteLine(Math.Abs(22.3)); //23
            ...
            Console.WriteLine(Math.Log(9)); //9 un tabanındaki logaritmik karşılık
            Console.WriteLine(Math.Exp(9)); // e üzeri 9
            Console.WriteLine(Math.Log10(19)); //10 sayısının logaritma 10 tabanındaki karşılığı
